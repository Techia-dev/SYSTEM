      ...
      >
        <div className="space-y-3">
          <Field label="Full name *">
            <input type="text" placeholder="Ahmed Mohamed" value={form.name}
              onChange={(e) => setForm({ ...form, name: e.target.value })}
              className={inputCls} />
          </Field>
          <Field label="Phone *">
            <input type="tel" placeholder="+20 100 000 0000" value={form.phone}
          ...
          <Field label="Level">
            <select value={form.level}
              onChange={(e) => setForm({ ...form, level: e.target.value as CandidateLevel })}
              className={inputCls}>
